...
import static core.Service.remove_time_use_item;
        ...
        switch (id_potion) {
            ...
            case 134: {
                ...
                if (list.size() > 0) {
                    ...
                    MenuController.send_menu_select(conn, +-id_potion, list_2);
                    

                } else {
                    send_notice_box(conn, "Trống");
                }
...
//                }catch(Exception e){e.printStackTrace();}
            ...
            default: {
                Service.send_notice_nobox_white(conn, "item 4 Chưa có chức năng này");
                break;
            }
        }
    }
