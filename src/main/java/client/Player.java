...
//    public Dungeon dungeon;
    ...
    // Main quest tracking
    public short questId; // quest hiện tại (0 = chưa nhận)
    public int questKill; // số mob đã giết cho quest hiện tại
    public int jointx;
    public boolean tai;
    public boolean xiu;
...
//                                (System.currentTimeMillis() + Long.parseLong(jsar2.get(2).toString()))));
            ...
            questKill = rs.getInt("quest_kill");
